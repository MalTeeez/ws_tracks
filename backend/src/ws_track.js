...
import { tracks_to_buffer, update_tracks_prometheus } from "./lib/track_util.js";
...
export const app = uws
  ...
  .ws("/*", {
    ...
    open: (
      /** @type {{ data: string; send: (arg0: any, binary?: boolean, compress?: boolean) => number; subscribe: (arg0: any) => any; end: (arg0: number) => void; "": any; }} */ ws
    ) => {
